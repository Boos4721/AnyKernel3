...
# Configure cpu governor settings
      ...
      echo 500 > /sys/devices/system/cpu/cpu0/cpufreq/schedhorizon/down_rate_limit_us
      ...
      echo 500 > /sys/devices/system/cpu/cpu4/cpufreq/schedhorizon/down_rate_limit_us
